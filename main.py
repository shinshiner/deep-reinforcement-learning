...
flags.DEFINE_integer('memory_size', 10, 'The size of experience memory (*= scale)')
...
flags.DEFINE_integer('t_train_max', 501, 'The maximum number of t while training (*= scale)')
